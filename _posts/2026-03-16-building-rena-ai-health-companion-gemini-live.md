...
![Rena home screen]({{ '/assets/images/rena-home.jpeg' | relative_url }})

The home screen shows your goal countdown, daily calorie breakdown, protein and water progress, and an AI-generated "Day so far" insight written fresh each morning from your actual logged data.

![Rena history screen]({{ '/assets/images/rena-history.jpeg' | relative_url }})

The History tab logs every meal with macros, every workout with calories burned, and water intake. Each day has an AI insight and activity summary generated by Gemini.

![Rena plan screen]({{ '/assets/images/rena-plan.jpeg' | relative_url }})

The Plan tab shows your workout plan and meal plan. Tap "Plan with Rena" to open a voice session — Rena generates a full plan through conversation, calibrated to your goal and recent history.

![Rena scan screen]({{ '/assets/images/rena-scan.jpeg' | relative_url }})

Point your camera at a plate or pick from your gallery. Rena identifies every food item, returns per-item calorie and macro estimates, and lets you adjust before logging.
